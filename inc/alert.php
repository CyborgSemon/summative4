<?php
    $realSite = 'Kensair';
    $realSiteURL = 'http://www.kensair.co.nz/';
    $designerName = 'Simon Watson';
...
function acknowledgement_script_custom(){
    ...
    <script type="text/javascript">
        if(sessionStorage.acknowledged){
            ...
            var html = document.getElementsByTagName('html')[0].style.overflow = "hidden";
            var html = document.getElementsByTagName('html')[0].style.overflow = "hidden";
        ...
        function confirmAcknowledge(){
            var body = document.getElementsByTagName('body')[0].removeAttribute('style');
            var html = document.getElementsByTagName('html')[0].removeAttribute('style');
